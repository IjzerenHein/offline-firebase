define(function(require, exports, module) {
	...
	*/
	function OfflineFirebase(args) {
		Firebase.apply(this, arguments);
	}
	OfflineFirebase.prototype = Object.create(Firebase.prototype);
    OfflineFirebase.prototype.constructor = OfflineFirebase;
	...
	*/
	var oldOn = OfflineFirebase.prototype.on;
	OfflineFirebase.prototype.on = function(eventType, callback, cancelCallback, context, cacheOffline) {
		...
		oldOn.call(this, eventType, metaCallback, cancelCallback, context);
	};

	/*
		Also override the .once(...) method in a similar manner
	*/
	var oldOnce = OfflineFirebase.prototype.once;
	OfflineFirebase.prototype.once = function(eventType, callback, cancelCallback, context, cacheOffline) {
		...
		// Register the callback with the superclass.
		oldOnce.call(this, eventType, metaCallback, cancelCallback, context);
	};
